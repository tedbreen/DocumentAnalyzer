...
function stringAnalyzer(str) {
    ...
    paragraphs.forEach(function(paragraph) {
        // var cleanParagraph = charRemoval(paragraph);  //REMOVING charaacter cleaner for now to implement simple Bigram feature
...
function bigramFinder(str) {
    var bigrams = {
        mostCommon: {},
        mostCommonCount: 0,
        pairs: {}
    };
    var words = str.split(" ")._select(function(word) {
        if (word.length > 0) {
            return word;
        }
    });
